...
MAX_ARTIFACT_INGRESS_BYTES = MAX_GENERATED_BUNDLE_BYTES
...
# ChangeSet transport budgets are distinct from patch/business validation limits.
MAX_DEVELOPMENT_CHANGE_SET_INLINE_BYTES = MAX_HIGH_LEVEL_INLINE_CONTENT_BYTES
MAX_DEVELOPMENT_CHANGE_SET_BYTES = 4 * 1024 * 1024
MAX_DEVELOPMENT_CHANGE_SET_FILE_BYTES = MAX_DEVELOPMENT_CHANGE_SET_BYTES
PREPARED_CHANGE_SET_TTL_SECONDS = 1800
...
def capabilities(build_sha: str) -> dict[str, Any]:
    ...
    return {
        ...
        "inline_transport_limit_bytes": MAX_INLINE_RESPONSE_BYTES,
        "artifact_ingress_limit_bytes": MAX_ARTIFACT_INGRESS_BYTES,
        ...
        "supports_artifact_plane": True,
        "development_change_set_inline_limit_bytes": MAX_DEVELOPMENT_CHANGE_SET_INLINE_BYTES,
        "development_change_set_file_limit_bytes": MAX_DEVELOPMENT_CHANGE_SET_FILE_BYTES,
        "development_change_set_limit_bytes": MAX_DEVELOPMENT_CHANGE_SET_BYTES,
        ...
        "web_safe_private_ci": {
            ...
            "continuation_strategy": "snapshot_resume",
            "formal_writer_route": "managed_development",
            "direct_private_ci": {
            ...
            "managed_development": {
                "formal_writer_recommended": True,
                "prepare_tool": "prepare_development_task",
            ...
            "attestation": {
                "required": True,
                "reusable_required": True,
                "create_tool": "create_attestation_for_passed_job",
                "validate_tool": "validate_attestation",
            },
            "identity": {
            ...
            "readiness_tool": "get_github_pull_request_merge_readiness",
            "merge_plan_tool": "plan_github_pull_request_merge",
            "merge_tool": "merge_github_pull_request",

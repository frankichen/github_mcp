...
class TestMCPTools:
    ...
    async def test_mygithub10_schema_and_gofmt_contract(self, monkeypatch):
        ...
        for name in ("build_github_patch", "replace_github_text_once", "edit_github_file_ranges", "apply_github_patch", "put_generated_files", "put_github_file", "put_github_files", "put_github_file_from_local_candidate", "get_mygithub_capabilities", "plan_private_ci_job", "resume_development_task", "recover_drifted_development_task", "recover_base_synced_development_task", "recover_retargeted_development_task"):
        ...
        assert capabilities["version"] == "12.9.10"
        ...
        assert capabilities["tool_count"] == 176
        assert capabilities["tool_manifest_count"] == 176
        assert capabilities["compatibility_tool_count"] == 176
